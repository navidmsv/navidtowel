...
(function () {
  ...
  function createMenu() {
      ...
      <div class="container header-inner">
        ...
        <nav class="nav">
          ...
          <div class="nav-category">
            <button type="button" class="nav-category-btn">
              دسته‌بندی‌ها <span>⌄</span>
            </button>
    ...
    <aside class="mobile-side-menu navid-compact-menu" id="mobileSideMenu">
      ...
      <div class="mobile-side-header">
        ...
        <button type="button" class="mobile-side-close" id="mobileMenuClose">
          ×
        </button>
      </div>
    ...
    <style>
      ...
      @media (max-width:800px){
        ...
        .navid-bottom-buttons .navid-mini-button{
          ...
          background:rgba(52,69,47,.82) !important;
          color:#fff !important;
          box-shadow:
            0 7px 18px rgba(52,69,47,.18),
            inset 0 1px 0 rgba(255,255,255,.28) !important;
          backdrop-filter:blur(18px) saturate(140%) !important;
          -webkit-backdrop-filter:blur(18px) saturate(140%) !important;
        }
  ...
  /* وقتی سبد در همین صفحه تغییر کند */
  ...
  /* وقتی سبد از تب دیگری تغییر کند */

  window.addEventListener(
    "storage",
    function (event) {
      if (event.key === "navidTowelCart") {
        updateCartCount();
      }
    }
  );
