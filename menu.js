...
(function () {
  ...
  function createMenu() {
    ...
    <aside class="mobile-side-menu navid-compact-menu" id="mobileSideMenu">
      ...
      <div class="navid-top-buttons">
        ...
        <a href="index.html" class="navid-mini-button">
          <span>⌂</span>
          <small>خانه</small>
        </a>

        <a href="shop.html" class="navid-mini-button">
          <span>◈</span>
      ...
      <div class="navid-bottom-buttons">
        ...
        <a href="index.html#contact" class="navid-mini-button">
          <span>☏</span>
          <small>تماس</small>
        </a>

        <a href="https://instagram.com/navidtowel"
           target="_blank"
           rel="noopener noreferrer"
           class="navid-mini-button social-btn">
          <span>◎</span>
          <small>اینستاگرام</small>
        </a>

        <a href="https://t.me/navidtowel"
           target="_blank"
           rel="noopener noreferrer"
           class="navid-mini-button social-btn">
          <span>➤</span>
    ...
    <style>
      ...
      .header-actions .cart-btn:hover{
        background:rgba(52,69,47,.94) !important;
      ...
      @media (max-width:800px){
        ...
        .navid-compact-menu{
          ...
          box-shadow:-15px 0 40px rgba(25,40,29,.15);
        ...
        .navid-compact-menu .mobile-side-brand strong{
          font-size:15px;
        }

        .navid-compact-menu .mobile-side-brand span{
          font-size:9px;
        }
        ...
        .navid-top-buttons .navid-mini-button{
          position:relative;
          min-width:0;
          ...
          cursor:pointer;
          box-shadow:
            0 5px 16px rgba(52,69,47,.07),
            inset 0 1px 0 rgba(255,255,255,.9);
          backdrop-filter:blur(18px) saturate(135%);
          -webkit-backdrop-filter:blur(18px) saturate(135%);
        }

        .navid-top-buttons .navid-mini-button span{
          font-size:16px;
          line-height:17px;
        }

        .navid-top-buttons .navid-mini-button small{
          font-size:8px;
          font-weight:800;
          white-space:nowrap;
        }
        ...
        .navid-top-buttons .openCart{
          ...
          box-shadow:
            0 7px 20px rgba(52,69,47,.2),
            inset 0 1px 0 rgba(255,255,255,.25) !important;
          backdrop-filter:blur(18px) saturate(140%) !important;
          -webkit-backdrop-filter:blur(18px) saturate(140%) !important;
        }

        .navid-top-buttons .openCart:hover{
          background:rgba(52,69,47,.94) !important;
        }
        ...
        .navid-compact-menu .mobile-side-links{
          padding:5px 11px 8px !important;
        }

        .navid-compact-menu .mobile-side-link{
        ...
        .navid-compact-menu .mobile-side-link .side-icon{
          width:32px;
          height:32px;
          border-radius:10px;
          display:inline-flex;
        ...
        .navid-compact-menu .mobile-side-link:hover{
          background:rgba(52,69,47,.07) !important;
        }

        .navid-compact-menu .mobile-side-category-list{
          margin:0 4px 5px;
          border-radius:12px;
          background:rgba(52,69,47,.035);
          overflow:hidden;
        }

        .navid-compact-menu .mobile-side-category-list a{
          min-height:34px;
          padding:7px 14px !important;
          font-size:12px;
          border-bottom:1px solid rgba(52,69,47,.05);
        }

        .navid-compact-menu .discount-badge{
          margin-right:auto;
          padding:3px 7px;
          border-radius:20px;
          background:#34452f;
        ...
        /* سه دکمه پایین — همان مدل بالا ولی همگی سبز */
        ...
        .navid-bottom-buttons{
          ...
          box-shadow:0 8px 22px rgba(30,50,38,.08);
        }

        .navid-bottom-buttons .navid-mini-button{
          position:relative;
          height:52px !important;
          min-width:0;
          border:1px solid rgba(255,255,255,.82) !important;
          ...
          cursor:pointer;
          box-shadow:
            0 7px 20px rgba(52,69,47,.16),
            inset 0 1px 0 rgba(255,255,255,.25) !important;
          backdrop-filter:blur(18px) saturate(140%) !important;
          -webkit-backdrop-filter:blur(18px) saturate(140%) !important;
        }

        .navid-bottom-buttons .navid-mini-button:hover{
          background:rgba(52,69,47,.94) !important;
          transform:translateY(-1px);
        }

        .navid-bottom-buttons .navid-mini-button span{
          width:22px;
          height:22px;
          display:flex;
          align-items:center;
        ...
        .navid-bottom-buttons .navid-mini-button small{
          color:#fff !important;
          font-size:8px;
          font-weight:800;
          white-space:nowrap;
        ...
        .navid-bottom-buttons .social-btn{
          border:1px solid rgba(255,255,255,.82) !important;
          background:rgba(52,69,47,.88) !important;
          color:#fff !important;
        }

        .navid-bottom-buttons .social-btn span{
          width:22px;
          height:22px;
          border-radius:0;
          display:flex;
        ...
        .navid-bottom-buttons .social-btn small{
          color:#fff !important;
        }
  ...
  /* عدد فارسی را به انگلیسی تبدیل می‌کند */
  ...
  function forceEnglishCartNumbers() {

    document.querySelectorAll(".cartCount").forEach(function (element) {

      element.textContent = toEnglishDigits(
  ...
  function setupCartPreview() {
    ...
    document.querySelectorAll(".openCart").forEach(function (button) {
      ...
      if (button.dataset.navidCartBound === "1") {
        return;
      }
